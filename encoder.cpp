...
char MORSE_CODE_DICT[37][6] = {
        ".-",   "-...", "-.-.", "-..",  ".","..-.", "--.",  "....", "..",   ".---", "-.-",  ".-..", "--",
        "-.",   "---",  ".--.", "--.-", ".-.",  "...",  "-",    "..-",  "...-", ".--",  "-..-", "-.--", "--..",
        ".----", "..---", "...--", "....-", ".....", "-....", "--...", "---..", "----.", "-----", "/"
};

char LETTER_AS_AN_INDEX[37] = {'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I', 'J', 'K', 'L', 'M', 'N', 'O', 'P', 'Q',
...
const char* symbol_separator = "0";


const char* letter_separator = "000";



const char* word_separator = "0000000";
...
char* encode_char(const char c) {
	static char result[50];
    int index = findIndex(LETTER_AS_AN_INDEX, 37, toupper(c));
    char* trans = MORSE_CODE_DICT[index];
    int symbol_index = 0;
...
#pragma HLS INTERFACE ap_ctrl_none port=return
    ...
    while (1) {
        ...
        char* encoded_data = encode_text(data);
